        ...
        <div className="border-t py-12 [border-image:linear-gradient(to_right,transparent,--theme(--color-slate-400/.25),transparent)1] md:py-20">
          ...
          <div className="mx-auto max-w-3xl pb-4 text-center md:pb-12">
            ...
            <p className="text-lg text-indigo-200/65">
              Customize how your AI assistant responds, collects information,
               and guides conversations. Set your workflows, define your requirements, and create customer experiences that match the way your business operates.
            </p>
          </div>
          ...
          <div className="mx-auto grid max-w-sm gap-12 sm:max-w-none sm:grid-cols-2 md:gap-x-14 md:gap-y-16 lg:grid-cols-3">
            <article>
              ...
              <p className="text-indigo-200/65">
                ...
                with instant AI-powered replies
              </p>
            </article>
            <article>
              <svg
              ...
              <p className="text-indigo-200/65">
                Gather details and understand customer needs
              </p>
            </article>
            <article>
              <svg
              ...
              <p className="text-indigo-200/65">
                Discover intent and track meaningful interactions
              </p>
            </article>
            <article>
              <svg
              ...
              <h3 className="mb-1 font-nacelle text-[1rem] font-semibold text-gray-200">
                21x Conversion Boost
              </h3>
              <p className="text-indigo-200/65">
                 Responding to website leads within
                  5 minutes makes you 21 times more likely to qualify them
              </p>
            </article>
            <article>
              <svg
              ...
              <p className="text-indigo-200/65">
                Half your web traffic leaves if chat waits hit 5 minutes
              </p>
            </article>
            <article>
              <svg
              ...
              <p className="text-indigo-200/65">
                 Nearly three-quarters of modern consumers demand
                 instant, personalized digital interactions
              </p>
            </article>
          </div>
        </div>
